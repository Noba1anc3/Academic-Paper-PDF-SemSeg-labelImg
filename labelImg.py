...
def pdf2img(pdfPath, imagePath):
    with tempfile.TemporaryDirectory() as path:
        ...
        for image in images_from_path:
            ...
            picname = (pdfPath.split('/')[-1]).split('.')[0] + '_'+ str(images_from_path.index(image) + 1)
            image.save(imagePath + '/' + '%s.png' %picname, 'PNG')
    ...
    def openDirDialog(self, _value=False, dirpath=None, silent=False):
        ...
        for i in name:
            if i.split('.')[-1] == 'pdf':
                ...
                imagePath = pdfPath.split('.')[0]
                pdf2img(pdfPath, imagePath)
